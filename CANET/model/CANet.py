...
class CANet(nn.Module):
    def __init__(self, dset, args):
        ...
        attr_word_emb_file = '{}_{}_attr.save'.format(args.dataset,args.emb_split, args.emb_type)
        attr_word_emb_file = os.path.join(args.main_root, 'word embedding', attr_word_emb_file)
        obj_word_emb_file = '{}_{}_obj.save'.format(args.dataset,args.emb_split, args.emb_type)
