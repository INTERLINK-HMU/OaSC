...
class CompositionDataset(Dataset):
    ...
    def __init__(
        ...
        if not self.update_image_features:
            ...
            feat_file = ospj( "./datasets/", self.data_dir,model + '_features.t7')
            print(feat_file)
    ...
    def parse_split(self):
        ...
        tr_attrs, tr_objs, tr_pairs = parse_pairs(
            ospj("./datasets/", self.data_dir, self.split, 'train_pairs.txt')
        )
        vl_attrs, vl_objs, vl_pairs = parse_pairs(
            ospj("./datasets/", self.data_dir, self.split, 'val_pairs.txt')
        )
        ts_attrs, ts_objs, ts_pairs = parse_pairs(
            ospj("./datasets/", self.data_dir,self.split, 'test_pairs.txt')
        )
    ...
    def get_split_info(self):
        ...
        '''
        data = torch.load(ospj("./datasets/", self.data_dir, 'metadata_{}.t7'.format(self.split)))
