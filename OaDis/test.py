...
def validate_ge(model, testloader, evaluator, device, topks=[1, 2, 3]):
    ...
    sel = ['AUC','closed_attr_match','closed_obj_match','best_unseen','best_seen','best_hm','AUC_attr','hm_open_attr_all_bias_max','seen_open_attr_all_bias_max','unseen_open_attr_all_bias_max']
    for k in topks:
...
print('Val set:')
auc, best_hm,auc_attr,best_hm_attr = validate_ge(model, valloader, evaluator_val_ge, device, topks=topks)
print('Test set:')
