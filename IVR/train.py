...
def test(epoch, image_extractor, model, testloader, evaluator, writer, args, logpath):
    global best_auc, best_hm,best_unseen, best_open_ub_attr_match, best_closed_ub_attr_match, best_open_ub_attr_match_max, best_closed_ub_attr_match_max,best_auc_attr 
    ...
    def save_checkpoint(filename):
        state = {
            ...
            'epoch': epoch,
            'AUC': stats['AUC'],
          #  'AUC_attr': stats['AUC_attr'],
          #  'HM_attr': stats['AUC_attr']
        }
        if image_extractor:
