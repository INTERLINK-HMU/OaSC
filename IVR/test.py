...
def test(image_extractor, model, testloader, evaluator, args):
        ...
        result = ''
        for key in ['closed_attr_match','closed_obj_match','best_seen','best_unseen','best_hm','AUC','AUC_attr','hm_open_attr_all_bias_max','seen_open_attr_all_bias_max','unseen_open_attr_all_bias_max']:
            result = result + key + '  ' + str(round(stats[key]*100, 1)) + '| '
