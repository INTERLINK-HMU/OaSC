...
CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/symnet_obj.yml" 
...
CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/aopp_obj.yml" 



CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/zero_shot_split1_tr.yml" 


CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/zero_shot_split1_tr_cw.yml" 


CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/zero_shot_split1_tr_object_ow.yml"
