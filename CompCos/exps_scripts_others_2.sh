...
# CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/mit_split2_tr.yml" 


# CUDA_VISIBLE_DEVICES=$cuda_device python train.py --config "./configs/compcos_dif_val/$dataset/mit_split2_tr_cw.yml" 
