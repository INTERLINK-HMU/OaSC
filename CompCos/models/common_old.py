...
class Evaluator:
    ...
    def __init__(self, dset, model):
        ...
        masks1 = [1 for _ in dset.pairs]
        masks2 = [1 if pair in test_pair_set else 0 for pair in dset.pairs]    
        print(masks1)
      #  print(test_pair_set)
        print(masks2)
        self.closed_mask = torch.BoolTensor(masks)
       # print( self.closed_mask)
    ...
    def generate_predictions(self, scores, obj_truth, bias = 0.0, topk = 5): # (Batch, #pairs)
      ...
      #  print(scores[0])
       ...
       # print(closed_scores[0])
        ...
        self.oracle_obj_mask=self.oracle_obj_mask.to(device)
        ...
        for i in range(len(attr_truth)):
          ...
          #  print(set(self.train_pairs))
            if pairs[i] in self.train_pairs:
              ...
              #  print(pairs[i],2)
                unseen_ind.append(i)
     #   print(set([pairs[i] for i in range(len(attr_truth))]))
       # print(set(self.train_pairs))
       # print(unseen_ind)
       # print(seen_ind)
        # print(set(pairs))
        # print(set(self.train_pairs))
        # print(set(self.test_pair_dict))
        # print(pairs)
        # print( self.train_pairs)
        # print(attr_truth)
        # print(pair_truth)
       ...
       # print(unseen_ind)
        ...
        print(unbiased_closed[0])

        print(unbiased_open[0])
        #################### Calculating AUC
        ...
        if( np.isnan(unseen_accuracy.any())):
        ...
        #print(seen_accuracy,unseen_accuracy,11111)
        ...
        if( np.isnan(unseen_accuracy.any())):
            ...
            stats['hm_unseen'] =0
            stats['hm_seen'] = 0
            stats['best_hm'] = np.max(seen_accuracy)
