...
def test(epoch, image_extractor, model, testloader, evaluator, writer, args, logpath, mode):
    ...
    '''
    global best_auc, best_hm, best_open_ub_attr_match, best_closed_ub_attr_match, best_open_ub_attr_match_max, best_closed_ub_attr_match_max,best_auc_attr 
    ...
    print(result)
    print(stats['AUC_attr'],best_auc_attr,stats['hm_open_attr_all_bias_max'],best_closed_ub_attr_match_max)
    print(stats['AUC_attr']>best_auc_attr,stats['hm_open_attr_all_bias_max']>best_closed_ub_attr_match_max,mode)
    if mode == 'val':
