...
parser.add_argument('--image_extractor', default = 'dino', help = 'Feature extractor model')
...
parser.add_argument('--aow', type=float, default=1.0)
...
parser.add_argument("--model_name_or_path", default="./data/Oscar_pretrained_models/base-vg-labels/ep_107_1192087", type=str,
                      help="Path to pre-trained model or shortcut name selected in the list")
parser.add_argument("--task_name", default="czsl", type=str,
                      help="The name of the task to train selected in the list: ")
parser.add_argument("--drop_out", default=0.1, type=float, help="Drop out for BERT.") # 0.3?
parser.add_argument("--img_feature_dim", default=2054, type=int, help="The Image Feature Dimension.") # 2054
parser.add_argument("--img_feature_type", default='resnet18', type=str, help="faster_r-cnn or mask_r-cnn") # faster_r-cnn
...
parser.add_argument("--max_seq_length", default=7, type=int,
...
parser.add_argument("--loss_type", default='', type=str, help="kl or xe")

parser.add_argument('--gpu',default=0, type=int,help='load checkpoint based on best attr peformr')
parser.add_argument('--attr', action='store_true', default=False, help='load checkpoint based on best attr peformr') 
parser.add_argument('--hm', action='store_true', default=False, help='load checkpoint based on best attr peformr') 
parser.add_argument('--auc', action='store_true', default=False, help='load checkpoint based on best attr peformr') 